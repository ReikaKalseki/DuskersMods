...
namespace ReikaKalseki.DIDrones {
	public static class DIExtensions {
		...
		*/
		...
		public static string toDebugString<E>(this IEnumerable<E> c, string delim = ",") {
		...
		public static List<E> getLastNItems<E>(this IList<E> li, int n) {
			return li.Skip(Math.Max(0, li.Count - n)).ToList();
		}
		...
		public static Room getRoom(this ITowItem it) {
			if (it is Drone d)
				return d.CurrentRoom;
			else if (it is ShipUpgradeInGameObject up)
				return up.roomLocation;
			return null;
		}

		public static bool isBroken(this ShipUpgradeInGameObject u) {
			switch (u.ShipUpgradeStatus) {
				case ShipUpgradeInGameObject.ShipUpgradeStatusEnum.InstalledBroken:
				case ShipUpgradeInGameObject.ShipUpgradeStatusEnum.InstalledBrokenLoose:
					return true;
				default:
					return false;
			}
		...
		public static void repair(this ShipUpgradeInGameObject u) {
			switch (u.ShipUpgradeStatus) {
				case ShipUpgradeInGameObject.ShipUpgradeStatusEnum.InstalledBroken:
					u.ShipUpgradeStatus = ShipUpgradeInGameObject.ShipUpgradeStatusEnum.InstalledWorking;
					break;
				case ShipUpgradeInGameObject.ShipUpgradeStatusEnum.InstalledBrokenLoose:
					u.ShipUpgradeStatus = ShipUpgradeInGameObject.ShipUpgradeStatusEnum.InstalledWorkingLoose;
					u.CanBeTowed = true;
					break;
				default:
					break;
